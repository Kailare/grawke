...
import { removeAckReactionAfterReply, shouldAckReaction } from "moltx/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/moltx") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
