...
import { removeAckReactionAfterReply, shouldAckReaction } from "grawke/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/grawke") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
