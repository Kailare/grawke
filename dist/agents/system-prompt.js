...
export function buildAgentSystemPrompt(params) {
    ...
    const lines = [
        ...
        "If you use exec/curl, NEVER paste the raw response. Summarize what happened.",
        "The user should NEVER see raw API responses, stack traces, or debug output in chat.",
        "",
