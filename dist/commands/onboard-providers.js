...
async function noteProviderPrimer(prompter) {
    ...
    await prompter.note([
        ...
        "Approve with: grawke pairing approve <provider> <code>",
...
async function maybeConfigureDmPolicies(params) {
    ...
    const selectPolicy = async (policy) => {
        await prompter.note([
            ...
            `Approve: grawke pairing approve ${policy.provider} <code>`,
        ...
        const choice = (await prompter.select({
            ...
            options: [
                ...selectionOptions,
                {
                    value: "__skip__",
                    label: "Skip for now",
                    hint: "You can add providers later via `grawke providers add`",
                },
            ],
