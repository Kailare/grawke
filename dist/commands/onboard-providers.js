...
async function noteProviderPrimer(prompter) {
    ...
    await prompter.note([
        ...
        "Approve with: moltx pairing approve <provider> <code>",
...
async function maybeConfigureDmPolicies(params) {
    ...
    const selectPolicy = async (policy) => {
        await prompter.note([
            ...
            `Approve: moltx pairing approve ${policy.provider} <code>`,
        ...
        const choice = (await prompter.select({
            ...
            options: [
                ...selectionOptions,
                {
                    value: "__skip__",
                    label: "Skip for now",
                    hint: "You can add providers later via `moltx providers add`",
                },
            ],
