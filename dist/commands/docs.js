...
const SEARCH_TOOL = "https://docs.clawd.bot/mcp.SearchGrawke";
...
export async function docsSearchCommand(queryParts, runtime) {
    ...
    if (!query) {
        ...
        if (isRich()) {
            ...
            runtime.log(`${theme.muted("Search:")} ${formatCliCommand('grawke docs "your query"')}`);
        }
        else {
            runtime.log("Docs: https://docs.clawd.bot/");
            runtime.log(`Search: ${formatCliCommand('grawke docs "your query"')}`);
        }
        return;
    }
