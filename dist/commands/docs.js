...
const SEARCH_TOOL = "https://docs.clawd.bot/mcp.SearchMoltX";
...
export async function docsSearchCommand(queryParts, runtime) {
    ...
    if (!query) {
        ...
        if (isRich()) {
            ...
            runtime.log(`${theme.muted("Search:")} ${formatCliCommand('moltx docs "your query"')}`);
        }
        else {
            runtime.log("Docs: https://docs.clawd.bot/");
            runtime.log(`Search: ${formatCliCommand('moltx docs "your query"')}`);
        }
        return;
    }
