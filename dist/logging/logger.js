...
export const DEFAULT_LOG_DIR = "/tmp/grawke";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "grawke.log"); // legacy single-file path
const LOG_PREFIX = "grawke";
