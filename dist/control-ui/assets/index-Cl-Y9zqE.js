  ...
  `}function oh(e){const t=e.hello?.snapshot,n=t?.uptimeMs?io(t.uptimeMs):"n/a",s=t?.policy?.tickIntervalMs?`${t.policy.tickIntervalMs}ms`:"n/a",i=(()=>{if(e.connected||!e.lastError)return null;const o=e.lastError.toLowerCase();if(!(o.includes("unauthorized")||o.includes("connect failed")))return null;const l=!!e.settings.token.trim(),p=!!e.password.trim();return!l&&!p?r`
        <div class="muted" style="margin-top: 8px;">
          ...
          <div style="margin-top: 6px;">
            <span class="mono">grawke dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">grawke doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px;">
            <a
              class="session-link"
      ...
      <div class="muted" style="margin-top: 8px;">
        ...
        <span class="mono">grawke dashboard --no-open</span>, or update the token,
        then click Connect.
        <div style="margin-top: 6px;">
          <a
            class="session-link"
        ...
        <div class="form-grid" style="margin-top: 16px;">
          ...
          <label class="field">
            ...
            <input
              ...
              placeholder="GRAWKE_GATEWAY_TOKEN"
            />
          </label>
          <label class="field">
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src="https://mintcdn.com/clawdhub/4rYvG-uuZrMK_URE/assets/pixel-lobster.svg?fit=max&auto=format&n=4rYvG-uuZrMK_URE&q=85&s=da2032e9eac3b5d9bfe7eb96ca6a8a26" alt="Grawke" />
            </div>
            <div class="brand-text">
              <div class="brand-title">GRAWKE</div>
