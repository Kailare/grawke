...
export function registerBrowserCli(program) {
    const browser = program
        ...
        .option("--url <url>", "Override browser control URL (default from ~/.grawke/grawke.json)")
        ...
        .action(() => {
        browser.outputHelp();
        defaultRuntime.error(danger(`Missing subcommand. Try: "${formatCliCommand("grawke browser status")}"`));
