...
export function registerBrowserCli(program) {
    const browser = program
        ...
        .option("--url <url>", "Override browser control URL (default from ~/.moltx/moltx.json)")
        ...
        .action(() => {
        browser.outputHelp();
        defaultRuntime.error(danger(`Missing subcommand. Try: "${formatCliCommand("moltx browser status")}"`));
