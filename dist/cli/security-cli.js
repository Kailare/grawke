...
export function registerSecurityCli(program) {
    ...
    security
        ...
        const lines = [];
        lines.push(heading("Grawke security audit"));
        lines.push(muted(`Summary: ${formatSummary(report.summary)}`));
        lines.push(muted(`Run deeper: ${formatCliCommand("grawke security audit --deep")}`));
        if (opts.fix) {
            lines.push(muted(`Fix: ${formatCliCommand("grawke security audit --fix")}`));
            if (!fixResult) {
