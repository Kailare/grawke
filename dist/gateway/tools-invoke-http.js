...
export async function handleToolsInvokeHttpRequest(req, res, opts) {
    ...
    const messageChannel = normalizeMessageChannel(getHeader(req, "x-moltx-message-channel") ?? "");
    const accountId = getHeader(req, "x-moltx-account-id")?.trim() || undefined;
    ...
    const allTools = createMoltXTools({
