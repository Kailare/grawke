...
MoltX has two separate “streaming” layers:
...
When block streaming is enabled, MoltX can **merge consecutive block chunks**
...
When draft streaming is active, MoltX disables block streaming for that reply to avoid double-streaming.
