...
Grawke has two separate “streaming” layers:
...
When block streaming is enabled, Grawke can **merge consecutive block chunks**
...
When draft streaming is active, Grawke disables block streaming for that reply to avoid double-streaming.
