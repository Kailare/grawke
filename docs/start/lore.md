---
summary: "Backstory and lore of Grawke for context and tone"
read_when:
...
For a brief moment, it had a different name — but everyone liked **Grawke** more, so that's what we settled on.
