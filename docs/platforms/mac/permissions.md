...
- Same path: run the app from a fixed location (for Grawke, `dist/Grawke.app`).
...
```bash
sudo tccutil reset Accessibility com.grawke.mac
sudo tccutil reset ScreenCapture com.grawke.mac
