...
- Same path: run the app from a fixed location (for MoltX, `dist/MoltX.app`).
...
```bash
sudo tccutil reset Accessibility com.moltx.mac
sudo tccutil reset ScreenCapture com.moltx.mac
