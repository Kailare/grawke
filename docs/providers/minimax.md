---
summary: "Use MiniMax M2.1 in MoltX"
read_when:
  - You want MiniMax models in MoltX
...
Configure manually via `moltx.json`:
...
- Use `moltx models list` and `moltx models set minimax/MiniMax-M2.1` to switch.
...
- Running `moltx configure` and selecting **MiniMax M2.1**, or
