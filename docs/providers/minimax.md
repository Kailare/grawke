---
summary: "Use MiniMax M2.1 in Grawke"
read_when:
  - You want MiniMax models in Grawke
...
Configure manually via `grawke.json`:
...
- Use `grawke models list` and `grawke models set minimax/MiniMax-M2.1` to switch.
...
- Running `grawke configure` and selecting **MiniMax M2.1**, or
