...
- **gateway host** → `grawke` process on the gateway machine
...
`~/.grawke/exec-approvals.json` directly.

CLI: `grawke approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
