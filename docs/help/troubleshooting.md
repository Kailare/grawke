...
You can also set `GRAWKE_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `grawke config get agents.defaults.models`
...
If you can, include the relevant log tail from `grawke logs --follow`.
