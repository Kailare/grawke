...
You can also set `MOLTX_VERBOSE=1` instead of the flag.
...
- Check the allowlist: `moltx config get agents.defaults.models`
...
If you can, include the relevant log tail from `moltx logs --follow`.
