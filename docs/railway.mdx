...
Deploy Grawke on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.app/new/template?template=https://github.com/vignesh07/grawke-railway-template" target="_blank" rel="noreferrer">Deploy on Railway</a>
...
- `https://<your-railway-domain>/grawke` — Control UI

## What you get

- Hosted Grawke Gateway + Control UI
...
- `GRAWKE_STATE_DIR=/data/.grawke` (recommended)
- `GRAWKE_WORKSPACE_DIR=/data/workspace` (recommended)
- `GRAWKE_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your Grawke state + workspace so you can migrate to another host without losing config or memory.
